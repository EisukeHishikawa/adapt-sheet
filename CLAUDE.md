...
docker compose exec frontend npm run test:e2e       # Playwright（現状未対応。frontend/Dockerfileのベースイメージがブラウザバイナリに非対応。ADR-014参照）

...
def build_prompt(
    *,
    ...
    return (
        ...
        "フォントサイズは一般的な請求書・帳票として詰まって読みやすい大きさにし、"
        "元のHTMLより大きくしないでください。目安として、帳票名（タイトル）は22px以下、"
        "セクション見出しは14px以下、明細・本文・その他は11px以下に収め、これより大きくしないでください。"
        "特に本文・明細は小さめ（10〜11px程度）にして、余白と行間で見やすさを確保してください。\n"
        f"{size_line}"

...
AdaptSheet AIのシステム構成・API設計・セキュリティ・CI/CDの概要をMermaid.jsで記述する。技術選定の理由は [`decisions.md`](./decisions.md) を参照。
...
flowchart LR
    ...
    GitHub --> CI["GitHub Actions CI<br/>・Vitest (フロント)<br/>・pytest (バック)<br/>・Biome / Ruff (静的解析)"]
